...
class Game():
    ...
    def main(self):
        ...
        while run:
            ...
            pygame.draw.rect(screen, self.PADDLE_COLOR, self.field)
            pygame.draw.rect(screen, self.STAND_COLOR, self.stand)
            pygame.draw.circle(screen, "WHITE", (-300, random.randint(0, 1000)), 25)
